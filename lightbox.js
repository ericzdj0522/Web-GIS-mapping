function FullPic(sourceFile, caption, lat, lng) {
...
FullPic.prototype.open = function() {
  ...
  image.dataset.lat = this.lat;
  image.dataset.lng = this.lng;
...
function initLightbox() {
  ...
  photos.forEach(function(photo) {
    ...
    photo.addEventListener('click', function() {
      ...
      var currentPhoto = new FullPic(photo.src, photo.dataset.caption, photo.dataset.lat, photo.dataset.lng);
      currentPhoto.open();
